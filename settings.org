...
;;   :bind
;;   ("C-S-<prior>" . centaur-tabs-backward)
;;   ("C-S-<next>" . centaur-tabs-forward))
#+END_SRC
** Awesome-tab
#+BEGIN_SRC emacs-lisp
...
;; (require 'awesome-tab)
;; (awesome-tab-mode t)
;; (global-set-key (kbd "M-S-<left>") 'awesome-tab-backward-tab)
;; (global-set-key (kbd "M-S-<right>") 'awesome-tab-forward-tab)
